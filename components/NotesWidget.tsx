      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={exportNotes}
            disabled={!note.trim()}
            className="rounded-lg bg-amber-400/10 px-3 py-2 text-xs text-amber-200 hover:bg-amber-400/20 transition disabled:opacity-50"
          >
            Export
          </button>
          <button
            onClick={clearNotes}
            disabled={!note.trim()}
            className="rounded-lg bg-amber-400/20 px-3 py-2 text-xs text-amber-200 hover:bg-amber-400/30 transition disabled:opacity-50"
          >
            Clear
          </button>
        </div>
